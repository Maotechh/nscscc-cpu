...
module id_stage (
  ...
  wire       [31:0]   area_stage_io_registers_0;
  wire       [31:0]   area_stage_io_registers_1;
  wire       [31:0]   area_stage_io_registers_2;
  wire       [31:0]   area_stage_io_registers_3;
  wire       [31:0]   area_stage_io_registers_4;
  wire       [31:0]   area_stage_io_registers_5;
  wire       [31:0]   area_stage_io_registers_6;
  wire       [31:0]   area_stage_io_registers_7;
  wire       [31:0]   area_stage_io_registers_8;
  wire       [31:0]   area_stage_io_registers_9;
  wire       [31:0]   area_stage_io_registers_10;
  wire       [31:0]   area_stage_io_registers_11;
  wire       [31:0]   area_stage_io_registers_12;
  wire       [31:0]   area_stage_io_registers_13;
  wire       [31:0]   area_stage_io_registers_14;
  wire       [31:0]   area_stage_io_registers_15;
  wire       [31:0]   area_stage_io_registers_16;
  wire       [31:0]   area_stage_io_registers_17;
  wire       [31:0]   area_stage_io_registers_18;
  wire       [31:0]   area_stage_io_registers_19;
  wire       [31:0]   area_stage_io_registers_20;
  wire       [31:0]   area_stage_io_registers_21;
  wire       [31:0]   area_stage_io_registers_22;
  wire       [31:0]   area_stage_io_registers_23;
  wire       [31:0]   area_stage_io_registers_24;
  wire       [31:0]   area_stage_io_registers_25;
  wire       [31:0]   area_stage_io_registers_26;
  wire       [31:0]   area_stage_io_registers_27;
  wire       [31:0]   area_stage_io_registers_28;
  wire       [31:0]   area_stage_io_registers_29;
  wire       [31:0]   area_stage_io_registers_30;
  wire       [31:0]   area_stage_io_registers_31;
  ...
  DecodeStage area_stage (
    ...
    .io_registers_0                         (area_stage_io_registers_0[31:0]                    ), //o
    .io_registers_1                         (area_stage_io_registers_1[31:0]                    ), //o
    .io_registers_2                         (area_stage_io_registers_2[31:0]                    ), //o
    .io_registers_3                         (area_stage_io_registers_3[31:0]                    ), //o
    .io_registers_4                         (area_stage_io_registers_4[31:0]                    ), //o
    .io_registers_5                         (area_stage_io_registers_5[31:0]                    ), //o
    .io_registers_6                         (area_stage_io_registers_6[31:0]                    ), //o
    .io_registers_7                         (area_stage_io_registers_7[31:0]                    ), //o
    .io_registers_8                         (area_stage_io_registers_8[31:0]                    ), //o
    .io_registers_9                         (area_stage_io_registers_9[31:0]                    ), //o
    .io_registers_10                        (area_stage_io_registers_10[31:0]                   ), //o
    .io_registers_11                        (area_stage_io_registers_11[31:0]                   ), //o
    .io_registers_12                        (area_stage_io_registers_12[31:0]                   ), //o
    .io_registers_13                        (area_stage_io_registers_13[31:0]                   ), //o
    .io_registers_14                        (area_stage_io_registers_14[31:0]                   ), //o
    .io_registers_15                        (area_stage_io_registers_15[31:0]                   ), //o
    .io_registers_16                        (area_stage_io_registers_16[31:0]                   ), //o
    .io_registers_17                        (area_stage_io_registers_17[31:0]                   ), //o
    .io_registers_18                        (area_stage_io_registers_18[31:0]                   ), //o
    .io_registers_19                        (area_stage_io_registers_19[31:0]                   ), //o
    .io_registers_20                        (area_stage_io_registers_20[31:0]                   ), //o
    .io_registers_21                        (area_stage_io_registers_21[31:0]                   ), //o
    .io_registers_22                        (area_stage_io_registers_22[31:0]                   ), //o
    .io_registers_23                        (area_stage_io_registers_23[31:0]                   ), //o
    .io_registers_24                        (area_stage_io_registers_24[31:0]                   ), //o
    .io_registers_25                        (area_stage_io_registers_25[31:0]                   ), //o
    .io_registers_26                        (area_stage_io_registers_26[31:0]                   ), //o
    .io_registers_27                        (area_stage_io_registers_27[31:0]                   ), //o
    .io_registers_28                        (area_stage_io_registers_28[31:0]                   ), //o
    .io_registers_29                        (area_stage_io_registers_29[31:0]                   ), //o
    .io_registers_30                        (area_stage_io_registers_30[31:0]                   ), //o
    .io_registers_31                        (area_stage_io_registers_31[31:0]                   ), //o
    .clk                                    (clk                                                ), //i
    .reset                                  (reset                                              )  //i
  );
  ...
  assign rf_to_diff[0] = area_stage_io_registers_0;
  assign rf_to_diff[1] = area_stage_io_registers_1;
  assign rf_to_diff[2] = area_stage_io_registers_2;
  assign rf_to_diff[3] = area_stage_io_registers_3;
  assign rf_to_diff[4] = area_stage_io_registers_4;
  assign rf_to_diff[5] = area_stage_io_registers_5;
  assign rf_to_diff[6] = area_stage_io_registers_6;
  assign rf_to_diff[7] = area_stage_io_registers_7;
  assign rf_to_diff[8] = area_stage_io_registers_8;
  assign rf_to_diff[9] = area_stage_io_registers_9;
  assign rf_to_diff[10] = area_stage_io_registers_10;
  assign rf_to_diff[11] = area_stage_io_registers_11;
  assign rf_to_diff[12] = area_stage_io_registers_12;
  assign rf_to_diff[13] = area_stage_io_registers_13;
  assign rf_to_diff[14] = area_stage_io_registers_14;
  assign rf_to_diff[15] = area_stage_io_registers_15;
  assign rf_to_diff[16] = area_stage_io_registers_16;
  assign rf_to_diff[17] = area_stage_io_registers_17;
  assign rf_to_diff[18] = area_stage_io_registers_18;
  assign rf_to_diff[19] = area_stage_io_registers_19;
  assign rf_to_diff[20] = area_stage_io_registers_20;
  assign rf_to_diff[21] = area_stage_io_registers_21;
  assign rf_to_diff[22] = area_stage_io_registers_22;
  assign rf_to_diff[23] = area_stage_io_registers_23;
  assign rf_to_diff[24] = area_stage_io_registers_24;
  assign rf_to_diff[25] = area_stage_io_registers_25;
  assign rf_to_diff[26] = area_stage_io_registers_26;
  assign rf_to_diff[27] = area_stage_io_registers_27;
  assign rf_to_diff[28] = area_stage_io_registers_28;
  assign rf_to_diff[29] = area_stage_io_registers_29;
  assign rf_to_diff[30] = area_stage_io_registers_30;
  assign rf_to_diff[31] = area_stage_io_registers_31;
